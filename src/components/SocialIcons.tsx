...
const SocialIcons = () => {
  ...
  const handleRedirect = (href: string, name: string) => {
    setRedirectTarget(name);
  ...
  return (
    <>
      <RedirectLoader isVisible={isRedirecting} targetName={redirectTarget} />
      ...
      >
        {socialLinks.map((social, index) => (
          <motion.button
            key={social.name}
            onClick={() => handleRedirect(social.href, social.name)}
